                ...
                <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    >
                        <Form.Group controlId="example">
                            <Form.Label style={{ width: '100%',left: '50%', display: 'flex', textAlign: 'center', position: 'relative'}}><h2><u>Example</u></h2></Form.Label>
                            <Form.Text as="big">
                        ...
                        <div style={{ width: '100%', display: 'flex', justifyContent: "center" }}>
                            ...
                            <table style={{ width: '170%', left: '40%', textAlign: 'center', position: 'relative', color: 'black' }}>
                                <tr>
                        ...
                        <br /><br /><br />
                        <Button style={{ textAlign: 'center', position: 'relative', left: '75%'}} variant="primary" type="submit">
                            Start Experiment
                        </Button>
                    </motion.div>
                </Form>
