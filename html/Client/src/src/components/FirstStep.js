...
const FirstStep = (props) => {
    ...
    // Call the server early so the graphps appear immediately.
	useEffect(() => {
        (async () => {
            ...
            <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    <Form.Group controlId="inform">
                        <Form.Label><h2 style={{textAlign: 'center', position: 'relative'}}>Informed Consent</h2></Form.Label>
                        <Form.Text id="informText" as="big">
                            <p style={{ width: '250px', textAlign: 'left', position: 'relative', color: 'black'  }}>
                                Dear participant,
                            </p>
                            <p style={{ width: '250px', textAlign: 'left',position: 'relative', color: 'black'  }}>
