            ...
            <Form className="input-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                >
                    <Form.Group controlId="introduction">
                        <Form.Label><h2 style={{textAlign: 'left', position: 'relative'}}><u>Introduction</u></h2></Form.Label>
                        <Form.Text as="big">
                            <p style={{width: '200px', textAlign: 'left', position: 'relative', color: 'black' }}>
                                Dear participant,
                            ...
                            <p style={{ width: '200px', textAlign: 'left', position: 'relative', color: 'black'  }}>Dear participant,
                    ...
                    <Button style={{ textAlign: 'left', position: 'relative'}} variant="primary" type="submit">
                        Got It!
                    </Button>
                </motion.div>
            </Form>
